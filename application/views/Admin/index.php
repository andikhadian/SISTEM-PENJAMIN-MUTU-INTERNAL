            ...
            <div class="col-lg-8 col-md-12 col-12 col-sm-12 mb-4">
                <div class="hero align-items-center bg-info text-white">
                    <div class="hero-inner text-center mt-4">
                        <h1>Ingin menunggah dokumen SPMI dengan cepat ?</h1>
                        <p class="lead mt-5">Anda memiliki akses untuk mengunggah dokumen SPMI. Untuk mempercepat proses pengunggahan dokumen, anda dapat menekan tombol dibawah ini.</p>
                        <div class="mt-4">
                            <a href="<?= base_url('Admin/Unggah') ?>" class="btn btn-outline-white btn-lg btn-icon icon-left"><i class="fas fa-upload"></i> Unggah Dokumen SPMI Sekarang</a>
                        </div>
                    </div>
                </div>
            </div>
