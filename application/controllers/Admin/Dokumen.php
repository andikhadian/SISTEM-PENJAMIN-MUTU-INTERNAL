...
class Dokumen extends CI_Controller
{
    ...
    public function hapus($id, $pemilik_dokumen, $jenis_dokumen, $kategori_dokumen, $file_dokumen)
    {
        unlink(FCPATH . 'assets/Documents/' . $pemilik_dokumen . '/' . $jenis_dokumen . '/' . $kategori_dokumen . '/' . $file_dokumen);
